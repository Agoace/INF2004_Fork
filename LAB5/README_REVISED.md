...
> **DRAFT — under review.** This is a proposed revision of [`README.md`](./README.md).
> The original remains in place and is still the version in use. Do not issue this
> to students until the review is complete.
